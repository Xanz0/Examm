...
function myFunction() {
  var elementt = document.body;
  elementt.classList.toggle("dark-mode");
}
    ...
    elMarks.innerHTML += `
                ...
                <div class="txt">
                  ...
                  <div class="btns d-flex">
                    <a href="https://www.pdfdrive.com/electron-in-action-e187688481.html" class="btn text-light"><img src="./photos/read.svg" alt="read"></a>
                    <img class="btn-delete" src="./photos/delete.svg" alt="delete">
                    </div>
                    </div>
                </div>
                `;
